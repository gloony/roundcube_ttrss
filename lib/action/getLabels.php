...
foreach( $items as $item )
{
  ...
  <a class="expand all active" id="trsLBL'.$item['id'].'" role="button" tabindex="-1" aria-disabled="false" onclick="ttrss.article.toggle.label('.$item['id'].', '.$_GET['mode'].', true); return false;" style="color:'.$item['bg_color'].'">
